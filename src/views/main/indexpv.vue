            ...
            <div class="fullscreencontainer">
                <div class="head">
                    ...
                    <div class="mainMiddle ">
                        <span class="headText">
                            <!-- <dv-decoration-11 style="width:auto;height:60px;">{{title}}</dv-decoration-11> -->
                            <!-- <dv-decoration-7 style="width:auto;height:30px;">{{ title }}</dv-decoration-7> -->
                            <dv-decoration-7 style="width:auto;height:30px;">{{'智能无人机草地空斑补播平台' }}</dv-decoration-7>
                        </span>
...
<script src="./indexpv.js"></script>
<style lang="scss" src="./indexpv.scss" scoped></style>
